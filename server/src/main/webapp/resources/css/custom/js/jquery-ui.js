...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		dayNames: ["일","월","화","수","목","금","토"],//["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], // For formatting
		dayNamesShort: ["일","월","화","수","목","금","토"],//["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], // For formatting
		dayNamesMin: ["일","월","화","수","목","금","토"],//["Su","Mo","Tu","We","Th","Fr","Sa"], // Column headings for days starting at Sunday
